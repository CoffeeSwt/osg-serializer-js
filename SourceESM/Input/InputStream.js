import '../TypeSerializers/_SerializerInitiator';
...
import { ObjectProperty } from '../Common/DataTypes';
import Log from '../Common/Log';
import Base64Encoder from '../Common/Base64Encoder';
...
class InputStream {
    ...
    readVectorFromReader(size, reader) {
        let arr = [];
        // todo when reading array of vectors - maybe use single array fot all
        for (let i = 0; i < size; i++)
            arr.push(reader());
        return arr;
    }
